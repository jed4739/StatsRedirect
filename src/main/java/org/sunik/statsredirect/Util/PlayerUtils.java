...
public class PlayerUtils {
    ...
    public static void playerAttributeChange(Player player, int strength, int constitution, int dexterity, int luck, int wis) {
        ...
        modifyPlayerAttribute(player, Attribute.GENERIC_ARMOR, (0.3 * strength) + (0.01 * wis) + (0.5 * luck));
        modifyPlayerAttribute(player, Attribute.GENERIC_ATTACK_SPEED, 4.0 + (0.1 * dexterity));
